...
def personOne():
  ...
  t1 = threading.Thread(target=deviceOn, args=("BedroomTwo", "Light", env, 'User Activity',))
  t1.start()
  pool.append(t1)
  time.sleep(random.uniform(0.6*10, 0.6*15))
  t2 = threading.Thread(target=deviceOn, args=("BedroomTwo", "Door", env, 'User Activity',))
  t2.start()
  pool.append(t2)
  ...
  t9 = threading.Thread(target=deviceOn, args=("BedroomTwo", "Door", env, 'User Activity',))
  t9.start()
  pool.append(t9)
  ...
  t10 = threading.Thread(target=deviceOff, args=("BedroomTwo", "Light", env, 'User Activity',))
  t10.start()
  pool.append(t10)
  time.sleep(random.uniform(0.03, 0.05))
  time.sleep(random.uniform(0.03, 0.05))
  if(random.randint(0, 3) == 1):
    t10 = threading.Thread(target=deviceOff, args=("BedroomTwo", "Curtain", env, 'User Activity',))
    t10.start()
    pool.append(t10)
  t11 = threading.Thread(target=deviceOn, args=("BedroomTwo", "Door", env, 'User Activity',))
  t11.start()
  pool.append(t11)
  time.sleep(random.uniform(0.05, 0.1))
  stateIncrease(globalFrame.thread_list,"LivingRoom", "HumanState", env)
  stateDecrease(globalFrame.thread_list,"BedroomTwo", "HumanState", env)
  time.sleep(random.uniform(0.03, 0.05))
  t12 = threading.Thread(target=deviceOff, args=("BedroomTwo", "Door", env, 'User Activity',))
  t12.start()
  pool.append(t12)
  time.sleep(random.uniform(0.1, 0.2))
  ...
  change_clothes.join()
  time.sleep(random.uniform(0.03, 0.05))
  t1 = threading.Thread(target=deviceOn, args=("LivingRoom", "Door", env, 'User Activity',))
  t1.start()
  pool.append(t1)
  time.sleep(random.uniform(0.03, 0.05))
  stateDecrease(globalFrame.thread_list,"LivingRoom", "HumanState", env)
  time.sleep(random.uniform(0.6*0.4, 0.6*1.5))
  t2 = threading.Thread(target=deviceOff, args=("LivingRoom", "Door", env, 'User Activity',))
  t2.start()  
  pool.append(t2)
  ...
  if(random.randint(0, 3) == 1): # 午休回家
    t3 = threading.Thread(target=deviceOn, args=("LivingRoom", "Door", env, 'User Activity',))
    t3.start()
    pool.append(t3)
    time.sleep(random.uniform(0.03, 0.05))
    stateIncrease(globalFrame.thread_list,"LivingRoom", "HumanState", env)
    t4 = threading.Thread(target=deviceOff, args=("LivingRoom", "Door", env, 'User Activity',))
    t4.start()  
    pool.append(t4)
    if(random.randint(0, 3) == 1):
      time.sleep(random.uniform(0.1, 0.2))
      ...
      t = threading.Thread(target=deviceOn, args=("BedroomTwo", "Door", env, 'User Activity',))
      t.start()
      pool.append(t)
      time.sleep(random.uniform(0.03, 0.05))
      stateDecrease(globalFrame.thread_list,"LivingRoom", "HumanState", env)
      stateIncrease(globalFrame.thread_list,"BedroomTwo", "HumanState", env)
      time.sleep(random.uniform(0.03, 0.05))
      t = threading.Thread(target=deviceOff, args=("BedroomTwo", "Door", env, 'User Activity',))
      t.start()  
      pool.append(t)
    ...
    # 14.00
    t = threading.Thread(target=deviceOn, args=("LivingRoom", "Door", env, 'User Activity',))
    t.start()
    pool.append(t)
    time.sleep(random.uniform(0.03, 0.05))
    stateDecrease(globalFrame.thread_list,"LivingRoom", "HumanState", env)
    time.sleep(random.uniform(0.3, 0.6*1.5))
    t = threading.Thread(target=deviceOff, args=("LivingRoom", "Door", env, 'User Activity',))
    t.start()  
    pool.append(t)
  ...
  t = threading.Thread(target=LivingRoom_device_list[0][random_device][0], args=(LivingRoom_device_list[0][random_device][1][0],LivingRoom_device_list[0][random_device][1][1], env, 'User Activity',))
  t.start()
  pool.append(t)    
  time.sleep(random.uniform(0.6*15, 0.6*20))   
  random_device = random.randint(0, len(LivingRoom_device_list)-1)
  ...
  change_clothes.join()
  time.sleep(random.uniform(0.1, 0.2))
  t1 = threading.Thread(target=deviceOn, args=("LivingRoom", "Window", env, 'User Activity',))
  t1.start()
  pool.append(t1)
  time.sleep(random.uniform(0.1, 0.2))
  ...
  t = threading.Thread(target=BedroomTwo_device_list[0][random_device][0], args=(BedroomTwo_device_list[0][random_device][1][0],BedroomTwo_device_list[0][random_device][1][1], env, 'User Activity',))
  t.start()
  pool.append(t)  
  if(random.randint(0, 3) == 1):   
  ...
  if(random.randint(0, 2) == 1):
    t12 = threading.Thread(target=deviceOn, args=("BedroomTwo", "Heater", env, 'User Activity',))
    t12.start()
    pool.append(t12) 
    time.sleep(random.uniform(0.6*10, 0.6*11))
    stateDecrease(globalFrame.thread_list,"BedroomTwo", "Humidity", env)
  if(random.randint(0, 2) == 1):
    t12 = threading.Thread(target=deviceOn, args=("BedroomTwo", "Window", env, 'User Activity',))
    t12.start()
    pool.append(t12)  
    time.sleep(random.uniform(0.1, 0.2))
  random_device = random.randint(0, len(BedroomTwo_device_list)-1)
  ...
  if(random.randint(0, 2) == 1):
    time.sleep(random.uniform(0.1, 0.2))
    t12 = threading.Thread(target=deviceOff, args=("BedroomTwo", "Curtain", env, 'User Activity',))
    t12.start()
    pool.append(t12)  
  time.sleep(random.uniform(0.6*10, 0.6*11))  
  t12 = threading.Thread(target=deviceOff, args=("BedroomTwo", "Window", env, 'User Activity',))
  t12.start()
  pool.append(t12)  
  time.sleep(random.uniform(0.1, 0.2))
  t1 = threading.Thread(target=deviceOff, args=("BedroomTwo", "Light", env, 'User Activity',))
  t1.start()
  pool.append(t1)
...
def personTwo():
  ...
  pool.append(t10)
  time.sleep(random.uniform(0.03, 0.05))
  t1 = threading.Thread(target=deviceOn, args=("BedroomTwo", "Window", env, 'User Activity',))
  t1.start()
  pool.append(t1)
  time.sleep(random.uniform(0.1, 0.2))
  if(random.randint(0, 3) == 1):
  ...
  if(random.randint(0, 3) == 1): # 午休回家
    ...
    pool.append(t4)
    if(random.randint(0, 2) == 1):
      t12 = threading.Thread(target=deviceOn, args=("LivingRoom", "Window", env, 'User Activity',))
      t12.start()
      pool.append(t12)  
    time.sleep(random.uniform(0.03, 0.05))
    if(random.randint(0, 3) == 1):
      ...
      pool.append(t)
      time.sleep(random.uniform(0.03, 0.05))
      t1 = threading.Thread(target=deviceOff, args=("LivingRoom", "Humidifier", env, 'User Activity',))
      t1.start()
      pool.append(t1)
      time.sleep(random.uniform(0.1, 0.2))
      stateIncrease(globalFrame.thread_list,"LivingRoom", "HumanState", env)
  ...
  time.sleep(random.uniform(0.6*25, 0.6*30))
  if(random.randint(0, 2) == 1):
      t12 = threading.Thread(target=deviceOn, args=("BedroomTwo", "Humidifier", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.03, 0.05))
  t = threading.Thread(target=deviceOn, args=("BedroomTwo", "Door", env, 'User Activity',))
  ...
  pool.append(t)
  if(random.randint(0, 3) == 1):
      t12 = threading.Thread(target=deviceOff, args=("BedroomTwo", "Heater", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.03, 0.05))
  if(random.randint(0, 2) == 1):
      t12 = threading.Thread(target=deviceOff, args=("BedroomTwo", "Humidifier", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.03, 0.05))
  t12 = threading.Thread(target=deviceOff, args=("BedroomTwo", "Window", env, 'User Activity',))
  ...
  pool.append(t) 
  if(random.randint(0, 2) == 1):
      t12 = threading.Thread(target=deviceOff, args=("BedroomTwo", "Light", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.03, 0.05))
  t12 = threading.Thread(target=deviceOff, args=("BedroomTwo", "Curtain", env, 'User Activity',))
...
def personThree():
  ...
  if(random.randint(0, 2) == 1):
      time.sleep(random.uniform(0.03, 0.05))
      t12 = threading.Thread(target=deviceOn, args=("BedroomOne", "Window", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
  time.sleep(random.uniform(0.6*10, 0.6*15))
  random_device = random.randint(0, len(BedroomOne_device_list)-1)
  t = threading.Thread(target=BedroomOne_device_list[0][random_device][0], args=(BedroomOne_device_list[0][random_device][1][0],BedroomOne_device_list[0][random_device][1][1], env, 'User Activity',))
  t.start()
  pool.append(t) 
  time.sleep(random.uniform(0.05, 0.1))
  if(random.randint(0, 5) == 1):
    ...
    get_up.start()
    get_up.join()
  t1 = threading.Thread(target=deviceOn, args=("BedroomOne", "Light", env, 'User Activity',))
  t1.start()
  pool.append(t1)
  time.sleep(random.uniform(0.6*10, 0.6*15))
  t2 = threading.Thread(target=deviceOn, args=("BedroomOne", "Door", env, 'User Activity',))
  t2.start()
  pool.append(t2)
  time.sleep(random.uniform(0.05, 0.1))
  ...
  if(random.randint(0, 2) == 1):   
    ...
    time.sleep(random.uniform(0.6*25, 0.6*30))
  time.sleep(random.uniform(0.6*25, 0.6*30))
  t9 = threading.Thread(target=deviceOn, args=("BedroomOne", "Door", env, 'User Activity',))
  t9.start()
  pool.append(t9)
  time.sleep(random.uniform(0.03, 0.05))
  stateDecrease(globalFrame.thread_list,"LivingRoom", "HumanState", env)
  ...
  time.sleep(random.uniform(0.6*5, 0.6*8))
  t10 = threading.Thread(target=deviceOff, args=("BedroomOne", "Light", env, 'User Activity',))
  t10.start()
  pool.append(t10)
  time.sleep(random.uniform(0.03, 0.05))
  t11 = threading.Thread(target=deviceOn, args=("BedroomOne", "Door", env, 'User Activity',))
  t11.start()
  pool.append(t11)
  time.sleep(random.uniform(0.05, 0.1))
  stateIncrease(globalFrame.thread_list,"LivingRoom", "HumanState", env)
  stateDecrease(globalFrame.thread_list,"BedroomOne", "HumanState", env)
  time.sleep(random.uniform(0.03, 0.05))
  t12 = threading.Thread(target=deviceOff, args=("BedroomOne", "Door", env, 'User Activity',))
  t12.start()
  pool.append(t12)
  time.sleep(random.uniform(0.6*10, 0.6*13)) 
  if(random.randint(0, 3) == 1):
    t10 = threading.Thread(target=deviceOff, args=("BedroomOne", "Curtain", env, 'User Activity',))
    t10.start()
    pool.append(t10)
  change_clothes = threading.Thread(target=changeClothes)
  change_clothes.start()
  ...
  if(random.randint(0, 3) == 1): # 午休回家
    ...
    if(random.randint(0, 3) == 1):
      time.sleep(random.uniform(0.6*15, 0.6*20))
      t = threading.Thread(target=deviceOn, args=("BedroomOne", "Door", env, 'User Activity',))
      t.start()
      pool.append(t)
      time.sleep(random.uniform(0.03, 0.05))
      stateDecrease(globalFrame.thread_list,"LivingRoom", "HumanState", env)
      stateIncrease(globalFrame.thread_list,"BedroomOne", "HumanState", env)
      time.sleep(random.uniform(0.03, 0.05))
      t = threading.Thread(target=deviceOff, args=("BedroomOne", "Door", env, 'User Activity',))
      t.start()  
      pool.append(t)
      time.sleep(random.uniform(0.6*5, 0.6*10))
      random_device = random.randint(0, len(BedroomOne_device_list)-1)
  ...
  time.sleep(random.uniform(0.1, 0.2))
  if(random.randint(0, 2) == 1):
      t12 = threading.Thread(target=deviceOn, args=("LivingRoom", "Heater", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.6*10, 0.6*11))
      stateDecrease(globalFrame.thread_list,"BedroomTwo", "Humidity", env)
  ...
  time.sleep(random.uniform(0.03, 0.05))
  if(random.randint(0, 2) == 1):
      t12 = threading.Thread(target=deviceOff, args=("LivingRoom", "Heater", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.6*10, 0.6*11))
      stateDecrease(globalFrame.thread_list,"LivingRoom", "Humidity", env)
  t12 = threading.Thread(target=deviceOff, args=("LivingRoom", "Window", env, 'User Activity',))
  t12.start()
  pool.append(t12) 
  time.sleep(random.uniform(0.03, 0.05))
  stateDecrease(globalFrame.thread_list,"LivingRoom", "HumanState", env)
  ...
  if(random.randint(0, 2) == 1):
      t12 = threading.Thread(target=deviceOff, args=("BedroomOne", "Curtain", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.03, 0.05))
  t1 = threading.Thread(target=deviceOff, args=("BedroomOne", "Light", env, 'User Activity',))
  t1.start()
  pool.append(t1)
...
def weekendpersonOne():
  ...
  if(random.randint(0, 4) == 1):
      ...
      stateDecrease(globalFrame.thread_list,"BedroomTwo", "Humidity", env)
  if(random.randint(0, 5) == 1):
      t12 = threading.Thread(target=deviceOn, args=("LivingRoom", "Humidifier", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.03, 0.05))
  time.sleep(random.uniform(0.6*15, 0.6*20))
  ...
  time.sleep(random.uniform(0.6*15, 0.6*20)) 
  if(random.randint(0, 2) == 1):
      t12 = threading.Thread(target=deviceOff, args=("LivingRoom", "Humidifier", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.03, 0.05))
  # 出门3小时
...
def weekendpersonThree():
  ...
  time.sleep(random.uniform(0.6*25, 0.6*30))
  if(random.randint(0, 5) == 1):
      t12 = threading.Thread(target=deviceOn, args=("BedroomOne", "Heater", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.6*10, 0.6*11))
      stateDecrease(globalFrame.thread_list,"LivingRoom", "Humidity", env)
      ...
      time.sleep(random.uniform(0.1, 0.2))
  if(random.randint(0, 4) == 1):
      t12 = threading.Thread(target=deviceOn, args=("BedroomOne", "Humidifier", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.1, 0.2))
  if(random.randint(0, 3) == 1):
  ...
  time.sleep(random.uniform(0.1, 0.2))
  if(random.randint(0, 2) == 1):
      t12 = threading.Thread(target=deviceOff, args=("BedroomOne", "Humidifier", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.1, 0.2))
  if(random.randint(0, 2) == 1):
      t12 = threading.Thread(target=deviceOff, args=("BedroomOne", "Window", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.1, 0.2))
  if(random.randint(0, 2) == 1):
      t12 = threading.Thread(target=deviceOff, args=("BedroomOne", "Heater", env, 'User Activity',))
      t12.start()
      pool.append(t12) 
      time.sleep(random.uniform(0.1, 0.2))
  if(random.randint(0, 2) == 1):
